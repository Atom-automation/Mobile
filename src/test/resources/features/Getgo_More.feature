...
@More @RegressionPack2 @RegressionPack
Feature: More

  Background: Login into account
    Given I'm on Getgo landing page

  Scenario: As a tester, I want see Options - About the cards,FAQ, Contact Us,Terms and conditions and Privacy on choosing More option from the Left Hand Menu
