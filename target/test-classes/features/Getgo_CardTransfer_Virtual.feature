...
@FundTransfervirtual @RegressionPack
Feature: Fund Transfer from Virtual card to another card
  ...
  Scenario Outline: As a tester, I want to complete a scheduled funds transfer transaction from my virtual card account so that I can pass on funds to another cardholder
    ...
    Examples:
      ...
      | Virtual     | Virtual_Username | Virtual_Password |Weekly         |
      | Virtual     | Virtual_Username | Virtual_Password |Annually       |


  Scenario Outline: As a tester, I want to complete a scheduled funds transfer transaction with future date from my virtual card account so that I can pass on funds to another cardholder
    Given I'm login into my "<accountType>" account with my "<username>" and "<password>"
    Given I'm on Getgo Fund transfer page of my "<accountType>" card account
    ...
    Examples:
      | accountType | username         | password         |frequency      |
      | Virtual     | Virtual_Username | Virtual_Password |Quarterly      |


  Scenario Outline: As a tester, I want to complete a funds transfer transaction from my virtual card account so that I can pass on funds to another cardholder and validating the completed transaction in activity page - Fund Transfer Page
    Given I'm login into my "<accountType>" account with my "<username>" and "<password>"
    Given I'm on Getgo Fund transfer page of my "<accountType>" card account
    When  I Enter card number, recipient name, amount, system date, frequency, and message
    And   I review transfer instruction and click submit
  ...
  Scenario Outline: As a tester, I want to complete a funds transfer transaction from my virtual card account so that I can pass on funds to another cardholder and validating the completed transaction in activity page - From Dashboard page
    Given I'm login into my "<accountType>" account with my "<username>" and "<password>"
    Given I'm on Getgo Fund transfer page of my "<accountType>" card account
    When  I Enter card number, recipient name, amount, system date, frequency, and message
    And   I review transfer instruction and click submit
